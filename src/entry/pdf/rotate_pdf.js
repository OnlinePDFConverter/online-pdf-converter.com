...
const outputFileName = '{name}_rotated.pdf';
const { startProcess } = initWorker({
    worker: new Worker(new URL('@src/workers/rotate_pdf.worker.js', import.meta.url), { type: 'module' }),
    fileUpload,
    elements,
    outputFileName
});
...
function bindEvents(pageElement) {

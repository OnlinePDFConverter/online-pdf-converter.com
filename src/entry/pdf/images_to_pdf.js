...
import '@css/pdf/images_to_pdf.css';
...
const outputFileName = '{name}_images_to.pdf';
const { startProcess } = initWorker({
    worker: new Worker(new URL('@src/workers/images_to_pdf.worker.js', import.meta.url), { type: 'module' }),
    fileUpload,
    elements,
    outputFileName
});

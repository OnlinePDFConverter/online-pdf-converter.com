...
import '@css/pdf/webp_to_pdf.css';
...
const outputFileName = '{name}_webp_to.pdf';
const { startProcess } = initWorker({
    worker: new Worker(new URL('@src/workers/webp_to_pdf.worker.js', import.meta.url), { type: 'module' }),
    fileUpload,
    elements,
    outputFileName
});

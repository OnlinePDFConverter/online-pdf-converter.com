...
import '@css/pdf/delete_pages.css';
...
const outputFileName = '{name}_delete_pages.pdf';
const { startProcess } = initWorker({
    worker: new Worker(new URL('@src/workers/delete_pages.worker.js', import.meta.url), { type: 'module' }),
    fileUpload,
    elements,
    outputFileName
});
